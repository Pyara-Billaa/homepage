  ...
  return (
    <>
      <header className="place-items-center">
        ...
        <div className="md:relative md:w-90 md:h-90">
          <figure className="relative text-center">
            <img
              className="w-70 sm:max-md:w-100 max-sm:h-100 md:h-90 md:w-90 m-auto mt-4 md:mt-0 shadow-[10px_10px_10px_rgba(0,0,0,0.15)]"
              src={luffyImg}
              alt="luffy image"
            />
            <figcaption className="w-50  absolute bottom-3 right-0 left-0 m-auto text-white text-5xl playfair text-shadow-[0px_2px_2px_rgba(0_0_0/0.4)] font-medium md:top-0 md:right-0 md:left-75 md:w-89">
              Monkey D. Luffy
            </figcaption>
          </figure>
        </div>
        <section className="md:overflow-hidden mt-8 md:shadow-[3px_3px_5px_4px_rgba(0_0_0/0.1)] md:w-150 md:relative md:mb-50 md:h-95">
          <h1 className="playfair text-4xl text-center mb-4">About</h1>
          <p className="w-70 sm:w-100 text-start m-auto roboto md:w-full md:overflow-hidden">
            Monkey D. Luffy, commonly known as "Straw Hat Luffy" or simply
            "Straw Hat", is the founder and captain of the Straw Hat Pirates. He
            ...
            believes that being the Pirate King means having the most freedom in
            the world.
          </p>
